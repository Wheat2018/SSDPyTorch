...
import sys
import numpy as np
from FlashNet.models.common_ops import *
from FlashNet.utils.ops.nms.nms_wrapper import nms
import cv2
...
class CenterFace(nn.Module):
    ...
    def post_process(self,
        ...
        boxes[:, 0] /= im_width / raw_width
        boxes[:, 2] /= im_width / raw_width
        boxes[:, 1] /= im_height / raw_height
        boxes[:, 3] /= im_height / raw_height
        # boxes = boxes / resize
...
if __name__=="__main__":
    ...
    from FlashNet.utils.misc import add_flops_counting_methods, flops_to_string, get_model_parameters_number

    img_name = "../images/1_Handshaking_Handshaking_1_579.jpg"
    trained_model = "../checkpoints/CenterFace.pth"
    use_cuda = True
    ...
    img = torch.FloatTensor(*input_size)
    ...
    # resize2 = 300 / img_origin.shape[1]
