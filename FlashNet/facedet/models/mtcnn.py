...
if __name__=="__main__":
    ...
    flops, params = get_model_complexity_info(pnet, (3, 640, 640))
    split_line = '=' * 30
    print('{0}\nInput shape: {1}\nFlops: {2}\nParams: {3}\n{0}'.format(
        split_line, input_size, flops, params))

    input_size = (1, 3, 24, 24)
    flops, params = get_model_complexity_info(rnet, (3, 24, 24))
    split_line = '=' * 30
    print('{0}\nInput shape: {1}\nFlops: {2}\nParams: {3}\n{0}'.format(
        split_line, input_size, flops, params))

    input_size = (1, 3, 48, 48)
    flops, params = get_model_complexity_info(onet, (3, 48, 48))
    split_line = '=' * 30
    print('{0}\nInput shape: {1}\nFlops: {2}\nParams: {3}\n{0}'.format(
        split_line, input_size, flops, params))