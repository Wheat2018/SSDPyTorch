...
class FCOSTargetGenerator(object):
    ...
    def __init__(self, retina_stages=4, base_stride=8,
                 valid_range=[(192, np.inf), (96, 192), (48, 96), (0, 48)], **kwargs):
    ...
    def generate_targets(self, img, boxes):
        ...
        # [H, W, N]
        eps = 1e-5
        ctr =(nd.minimum(of_l, of_r) / nd.maximum(of_l, of_r)) * (nd.minimum(of_t, of_b) / nd.maximum(of_t, of_b) + eps)
