...
class preproc_fcosface(object):
    ...
    def __call__(self, image, targets):
        ...
        box_target, box_mask, ldmk_target, ldmk_mask = \
        self.target_generator.generate_targets(image_t, boxes, ldmks_t)

        return image_t, box_target, box_mask, ldmk_target, ldmk_mask


class preproc_fcosface_vis(object):
