...
from ...facedet.utils.bbox.box_utils import match, match_distillation, log_sum_exp, decode
...
class DistillationMimicLoss(nn.Module):
    ...
    def __init__(self, num_classes, overlap_thresh, prior_for_matching, bkg_label, neg_mining, neg_pos, neg_overlap,
                 encode_target):
        super(DistillationMimicLoss, self).__init__()
...
#--------------------------------------------------------------------------------------------------------
        ...
        # print('feat_stu.size()', feat_stu.size())
        loss_mimic = F.smooth_l1_loss(feat_stu, feat_tch, size_average=False)
# --------------------------------------------------------------------------------------------------------
